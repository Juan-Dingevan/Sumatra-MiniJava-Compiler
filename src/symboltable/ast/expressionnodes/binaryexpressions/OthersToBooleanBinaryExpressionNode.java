...
public abstract class OthersToBooleanBinaryExpressionNode extends BinaryExpressionNode {
    public Type check() throws CompilerException {
        ...
        boolean lhsConformsToRHS = Type.typesConformInContext(lhsType, rhsType, contextClass);
        boolean rhsConformsToLHS = Type.typesConformInContext(rhsType, lhsType, contextClass);
